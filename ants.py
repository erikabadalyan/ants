...
class Place(object):
    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                # BEGIN Problem 9
                if self.ant.can_contain(insect) and not self.ant.contained_ant:
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            "*** YOUR CODE HERE ***"
            if isinstance(insect, QueenAnt) and insect.true_queen < 1:
                return
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while start is not hive:
            B = random_or_none(start.bees)
            if counter <= self.max_range and counter >= self.min_range and B:
                return B
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        #reduce the armor of all the bees inside if self.armor <= 0
        # END Problem 5
...
class HungryAnt(Ant):
    ...
    def eat_bee(self, bee):
        ...
        # BEGIN Problem 6
        "*** YOUR CODE HERE ***"
        self.digesting = self.time_to_digest # END Problem 6
...
# END Problem 13
    ...
    def action(self, colony):
        ...
        while start is not None:
            if start.ant:
                ant = start.ant
                if ant.is_container and ant.contained_ant and ant.contained_ant.not_doubled:
                    ant.contained_ant.damage = ant.contained_ant.damage * 2
                    ant.contained_ant.not_doubled = False
                 ant.not_doubled:
                    ant.damage = ant.damage * 2
                    ant.not_doubled = False
            start = start.exit
        # END Problem 13
